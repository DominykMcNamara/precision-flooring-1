...
export const Services = () => {
  return (
    <div className="w-screen">
      <div className=" desktop:w-3/4 laptop:w-3/4 tablet:w-screen mobile:w-screen bg-stone-600 mx-auto flex desktop:flex-row mobile:flex-col justify-center align-center flex-row p-10 desktop:p-15 mt-20 rounded">
        <img
          src={BirchFloor}
          alt="Birchwood Floor"
